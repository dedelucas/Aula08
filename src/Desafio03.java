...
A main do seu programa deve ter a leitura dos lados do triângulo e a chamada da função que retorna o tipo dele. 
    ...
    public static boolean existeTriangulo(int ladoA,int ladoB,int ladoC) {
        return validaLados(ladoA, ladoB, ladoC) && validaLados(ladoA, ladoC, ladoB) && validaLados(ladoB, ladoC, ladoA);
        /*if (validaLados(ladoA, ladoB, ladoC) && validaLados(ladoA, ladoC, ladoB) && validaLados(ladoB, ladoC, ladoA)) {
            return true;
        }else {
            return false;
        }*/
